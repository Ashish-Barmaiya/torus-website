...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-sticky w-full border-b border-border-subtle bg-surface-primary transition-colors">
      ...
      <div
        className={`fixed top-0 bottom-0 right-0 z-modal w-full max-w-xs bg-surface-primary border-l border-border-subtle p-space-6 shadow-xl transition-transform duration-300 md:hidden ${mobileMenuOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
